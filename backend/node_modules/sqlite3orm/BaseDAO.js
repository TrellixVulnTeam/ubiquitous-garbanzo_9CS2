...
class BaseDAO {
    ...
    selectOne(whereOrFilter, params) {
        return this.queryModel.selectOne(this.sqldb, this.toFilter(whereOrFilter, query_1.TABLEALIAS), params);
    }
    /**
    ...
    countAll(whereOrFilter, params) {
        return this.queryModel.countAll(this.sqldb, this.toFilter(whereOrFilter, query_1.TABLEALIAS), params);
    }
    /**
    ...
    exists(whereOrFilter, params) {
        return this.queryModel.exists(this.sqldb, this.toFilter(whereOrFilter, query_1.TABLEALIAS), params);
    }
    /**
    ...
    toFilter(whereOrFilter, tableAlias) {
        if (whereOrFilter && (0, query_1.isFilter)(whereOrFilter)) {
